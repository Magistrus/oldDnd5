...
public class TavernaController {
	...
	@GetMapping
	public String getForm(Model model, Device device, String tavernaType, String tavernaCategory, String habitatType) {
		...
		String ownerName = "";
		if (!race.getAllNames().isEmpty()) {
			List<String> names = new ArrayList<>(race.getAllNames().getOrDefault(men ? Sex.MALE : Sex.FEMALE, Collections.emptySet()));
			if (names.isEmpty()) {
