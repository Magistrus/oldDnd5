...
import com.dnd5e.wiki.controller.CreatureController.FirstElement;
...
public class CalculatorController {
	...
	@GetMapping("/master")
	public String getMaster(Model model, Device device) {
	...
	public String getBuyMagicThingsForm(Model model, Device device) {
		model.addAttribute("device", device);
		model.addAttribute("costs", new float[] { 0, 0.1f, 0.2f, 1, 2, 4, 10 });
	...
	public String getWildMagicRandom(Model model, Device device) {
		model.addAttribute("device", device);
	...
	@GetMapping("/madness")
	public String madness(Model model, Device device, String typeMadness) {
		model.addAttribute("device", device);
	...
	@GetMapping("/trader")
	public String getTraiderForm(Model model, Device device) {
		model.addAttribute("device", device);
	...
	public String getRandomEncountersForm(Model model, Device device) {
		model.addAttribute("device", device);
	...
	public String getRandomEncounters(Integer start, Integer end, Integer level, HabitatType type, Model model, Device device) {
		model.addAttribute("device", device);
	...
	@PostMapping("/trader")
	public String generateTraider(Model model, Integer result, Integer mageRang, Device device) {
		model.addAttribute("device", device);
	...
	@GetMapping("/treasure")
	public String getTreasureForm(Model model, Device device) {
		model.addAttribute("device", device);
		model.addAttribute("result", 1);
	...
	public String getTreasures(Model model, Device device, Integer cr) {
		model.addAttribute("device", device);
		int coper = 0;
		int silver = 0;
		int gold = 0;
